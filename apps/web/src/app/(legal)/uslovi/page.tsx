...
export default function UsloviPage() {
  return (
    <>
      <h1 className="text-2xl font-semibold text-white">Uslovi korišćenja</h1>
      <p className="text-zinc-400">Poslednja izmena: 10. 8. 2026.</p>

      <h2 className="text-lg font-semibold text-white">1. Ko pruža uslugu</h2>
      <p>
      ...
      <h2 className="text-lg font-semibold text-white">2. Šta usluga radi</h2>
      <p>
      ...
      <h2 className="text-lg font-semibold text-white">3. Nalog</h2>
      <p>
      ...
      <h2 className="text-lg font-semibold text-white">4. Krediti i plaćanje</h2>
      <ul className="list-disc space-y-1 pl-5">
        <li>Usluga se plaća unapred, u kreditima. Cena svakog alata je prikazana pre pokretanja posla.</li>
        <li>
          <strong className="text-zinc-200">Naplaćuje se samo uspešan posao.</strong> Ako posao ne uspe, krediti se ne
      ...
      <h2 className="text-lg font-semibold text-white">5. Materijal koji otpremaš</h2>
      <p>
        ...
        <a href="/privatnost" className="text-brand-200 hover:underline">
          Politici privatnosti
        </a>
        .
      </p>
      <p>
        <strong className="text-zinc-200">Jamčiš da imaš pravo na materijal koji otpremaš.</strong> Ne otpremaj tuđe
        snimke, muziku ni fotografije bez dozvole.
      </p>

      <h2 className="text-lg font-semibold text-white">6. Snimci uvezeni sa drugih platformi</h2>
      ...
      <h2 className="text-lg font-semibold text-white">7. Rezultat</h2>
      <p>
      ...
      <h2 className="text-lg font-semibold text-white">8. Šta nije dozvoljeno</h2>
      <ul className="list-disc space-y-1 pl-5">
      ...
      <h2 className="text-lg font-semibold text-white">9. Dostupnost</h2>
      <p>
      ...
      <h2 className="text-lg font-semibold text-white">10. Odgovornost</h2>
      <p>
      ...
      <h2 className="text-lg font-semibold text-white">11. Izmene uslova</h2>
      <p>
      ...
      <h2 className="text-lg font-semibold text-white">12. Merodavno pravo</h2>
