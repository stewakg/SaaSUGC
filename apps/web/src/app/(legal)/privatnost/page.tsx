...
export default function PrivatnostPage() {
  return (
    <>
      <h1 className="text-2xl font-semibold text-white">Politika privatnosti</h1>
      <p className="text-zinc-400">Poslednja izmena: 10. 8. 2026.</p>

      <h2 className="text-lg font-semibold text-white">1. Ko obrađuje tvoje podatke</h2>
      <p>
      ...
      <h2 className="text-lg font-semibold text-white">2. Koje podatke prikupljamo i zašto</h2>
      ...
      <h2 className="text-lg font-semibold text-white">3. Kome se podaci prosleđuju</h2>
      <p>
      ...
      <p className="rounded-lg border border-white/10 bg-white/5 p-3">
        <strong className="text-zinc-200">Prenos van EU.</strong> Više servisa sa spiska je izvan Evropske unije. Za
      ...
      <h2 className="text-lg font-semibold text-white">4. Koliko dugo čuvamo</h2>
      <p>
      ...
      <h2 className="text-lg font-semibold text-white">5. Tvoja prava</h2>
      <p>
      ...
      <h2 className="text-lg font-semibold text-white">6. Kolačići</h2>
      <p>
      ...
      <h2 className="text-lg font-semibold text-white">7. Sadržaj koji generiše veštačka inteligencija</h2>
      <p>
        Skripte, glas i slike pravi veštačka inteligencija na osnovu onoga što uneseš. Rezultat može biti netačan ili
        neprikladan i <strong className="text-zinc-200">ti si odgovoran da ga pregledaš pre objave</strong>. Posebno:
