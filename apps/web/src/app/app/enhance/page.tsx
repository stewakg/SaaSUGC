  ...
  const steps: WizardStep[] = [
    {
      ...
      content: (
        <div className="space-y-4">
          <p className="text-sm text-txt-mid">Otpremi sliku ili video kome treba popraviti kvalitet.</p>
          <FileDropzone
      ...
      content: (
        <div className="space-y-4">
          <label className="block">
            <span className="mb-1 block text-sm text-txt-mid">Uvećanje rezolucije</span>
          ...
          <label className="flex items-center gap-3">
            ...
            />
            <span className="text-sm text-txt-mid">Dodatno izoštri detalje</span>
          </label>
        </div>
      ),
    },
...
function GenerateStep({
  ...
  return <p className="text-sm text-txt-mid">Klikni „Pokreni&rdquo; da popraviš kvalitet.</p>;
}
